...
angular
    .module('RDash')
    .directive('amColMultiChart', ['$rootScope',amColMultiChart]);

function amColMultiChart($rootScope) {
    var directive = {
        restrict: 'E',
        transclude: true,
        scope: {
        ...
        templateUrl: 'templates/directives/amColMultiChart/amColMultiChartTmpl.html',
