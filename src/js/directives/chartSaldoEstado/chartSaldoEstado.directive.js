...
angular
    .module('RDash')
    .directive('chartSaldoEstado', ['$rootScope',chartSaldoEstado]);

function chartSaldoEstado($rootScope) {
    var directive = {
        restrict: 'E',
        transclude: true,
        scope: {
        ...
        templateUrl: 'templates/directives/chartSaldoEstado/chartSaldoEstado.directive.html',
